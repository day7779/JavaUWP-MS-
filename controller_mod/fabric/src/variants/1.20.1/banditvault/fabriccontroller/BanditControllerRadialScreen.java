...
public final class BanditControllerRadialScreen extends class_437 {
    ...
    private static class_1799 iconFor(String keyId) {
        ...
        // method_43902 and method_17966 are the only registry lookups shaped the same from 1.20.1 to 1.21.4
        class_1792 resolved = class_7923.field_41178.method_17966(class_2960.method_43902("minecraft", item)).orElse(null);
