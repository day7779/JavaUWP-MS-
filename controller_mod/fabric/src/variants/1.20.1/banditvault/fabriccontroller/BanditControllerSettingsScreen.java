...
public final class BanditControllerSettingsScreen extends class_437 {
    ...
    // mouseScrolled took three doubles on 1.20.1 and four from 1.20.2, so both are declared
    public boolean method_25401(double mouseX, double mouseY, double amount) {
        return scrollPicker(amount);
    }

    public boolean method_25401(double mouseX, double mouseY, double horizontal, double vertical) {
        return scrollPicker(vertical);
    }

    private boolean scrollPicker(double vertical) {
