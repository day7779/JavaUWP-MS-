...
public final class BanditControllerSettingsScreen extends Screen {
    ...
    public BanditControllerSettingsScreen(Screen parent) {
    ...
    private void drawDetails(GuiGraphicsExtractor context, Layout layout) {
        ...
        if (captureOption != null) {
            ...
            if (option.kind == Kind.BIND) {
                BanditControllerGuide.drawBar(context, this.font, layout.detailX + layout.detailW / 2, y + 16,
    ...
    private void drawPicker(GuiGraphicsExtractor context, int mouseX, int mouseY) {
        ...
        BanditControllerSettings settings = BanditControllerSettings.get();
        BanditControllerGuide.drawBar(context, this.font, this.width / 2, layout.footerY,
